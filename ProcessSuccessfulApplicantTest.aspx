<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ProcessSuccessfulApplicantTest.aspx.cs" Inherits="ProcessSuccessfulApplicantTest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">   
    ...
    <div class="content-inner">
                ...
                <asp:GridView ID="gdvList" runat="server" ForeColor="Black" class="table table-striped" AutoGenerateColumns="false" GridLines="None" EmptyDataText=" No Successful Applicant Exist "
                     ...
                     <div class="row">
                        <div class="col-xl-6">
                        <asp:Button ID="btnMoveApplicants" class="btn btn-secondary" Visible ="false"  OnClick="btnMoveApplicants_Click"  runat="server" Text="Move Sucessful Applicant" />
                            </div>
                         </div>
                                            </div>
                                            </div>
