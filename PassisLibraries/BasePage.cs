    ...
    public class BasePage : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            if (Session["UserSession"] != null)
            {
                ...
                //try
                //{
                //    globalUniqueId = Request.QueryString["g"];
                //}
                //catch { }
                ...
                //else
                //{
                //    TransactionLog log = new TransactionLogLIB().RetrieveTransactionLogByGUID(globalUniqueId);
                //    if (log == null)
                //    {
                //        Response.Redirect("~/login.aspx");
                //    }
                //    else
                //    {
                //        if (log.FinalTransactionStatus == (int)PaymentStatus.Successful)
                //        {
                //            Response.Redirect("~/login.aspx");
                //        }
                //        else
                //        {
                //            PASSIS.LIB.User logonUser = new UsersLIB().RetrieveUser(log.UserId);
                ...
                {
                    PASSIS.LIB.PAConfig.LogAudit(PASSIS.LIB.PAConfig.AuditAction.Login, Request.Url.AbsoluteUri, ex.InnerException.ToString(), logonUser.Id);
