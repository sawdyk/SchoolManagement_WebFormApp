...
public partial class PrintResultt_748 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new PrintResultt_748().schSession().Distinct();
    ...
    protected void addResultSummaryPageTaiSolarinSecondaryThird(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        PdfPCell cell14 = new PdfPCell(new Phrase("", blackFnt8)); cell14.Colspan = 3; cell14.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
