<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="UploadAdmissionTestScores.aspx.cs" Inherits="UploadAdmissionTestScores" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>UPLOAD ADMISSION TEST SCORES</h4>
                                    </div>
...
<PagerSettings FirstPageText="&lt;i class=&quot;la  la-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-left&quot;&gt;&lt;/i&gt;"
                     ...
                     <div class="row">
                        <div class="col-xl-6">
                        <asp:Button ID="btnSaveTestScore" class="btn btn-secondary"   OnClick="btnSaveTestScore_Click"  runat="server" Text="Save Test" />
                            </div>
                         </div>
                                            </div>
                                            </div>
