<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ViewStaff2.aspx.cs" Inherits="ViewStaff2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
      ...
      <table cellpadding="0" cellspacing="0" width="100%">
       <tr>
        ...
        <tr>
            <td align="left">
                                                          <asp:Label ID="lblStaffs" ForeColor="Black" runat="server" Visible="true" Text="LIST OF STAFFS"></asp:Label>
                               ...
                               <asp:GridView ID="gdvList" EmptyDataText="NO STAFF" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" class="table table-striped"
                                                 CellPadding="4" ForeColor="#333333" GridLines="None"  Width="100%" Height="200px"  PageSize="20" OnPageIndexChanging="gdvList_PageIndexChanging" >
                                   <%--OnRowCancelingEdit="gvCampus_RowCancelingEdit" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="USERNAME">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="lblName" runat="server" ForeColor="#0066ff" Text='<%# Eval("Username")  %>' NavigateUrl='<%# Eval("Id", "AdmiAssignSubjects.aspx?mode=view&id={0}") %>'></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="LASTNAME">
                                                     ...
                                                     <asp:TemplateField HeaderText="EMAIL ADDRESS">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox1" Text='<%# Eval("EmailAddress")  %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label1" Text='<%# Eval("EmailAddress") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="ROLE">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# getRoleFromUserRole(Eval("Id")) %>' Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label3" runat="server" Text='<%# getRoleFromUserRole(Eval("Id")) %>' ></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="CAMPUS">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="TextBox3" Text='<%# getCampusName(Eval("SchoolCampusId")) %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label4" Text='<%# getCampusName(Eval("SchoolCampusId")) %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LinkButton3" CommandArgument='<%# Eval("Id")  %>' runat="server" CausesValidation="False" CommandName="Edit" Text="Edit" ToolTip="Edit"><i class="fa fa-edit fa-2x"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
