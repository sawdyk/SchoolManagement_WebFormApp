<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="TestInvitation.aspx.cs" Inherits="TestInvitation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">   
                                        ...
                                        <form class="form-horizontal">
                                          ...
                                          <asp:Label ID="lblResultMsg" runat="server" Text="" class="text-success ml-2"></asp:Label>
                                              ...
                                              <div class="form-group row mb-3">
                                                   ...
                                                   <asp:TextBox ID="txtDateOfTest" placeholder="MM-dd-yyyy" class="form-control" TabIndex="25"  runat="server" MaxLength="10"></asp:TextBox>
                                               <ajaxToolKit:CalendarExtender ID="myDateFromCal" Format="MM-dd-yyyy"  runat="server"  TargetControlID="txtDateOfTest" PopupButtonID="ImageButton1" PopupPosition="BottomLeft"></ajaxToolKit:CalendarExtender>
                                                </div>
                                                      </div>
                                                </form>    
                                        <br /><br />
   ...
   <PagerSettings FirstPageText="&lt;i class=&quot;la  la-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-left&quot;&gt;&lt;/i&gt;"
                                ...
                                NextPageText="&lt;i class=&quot;la la-arrow-right&quot;&gt;&lt;/i&gt;" PreviousPageText="&lt;i class=&quot;la la-arrow-left&quot;&gt;&lt;/i&gt;" />
                                    ...
                                    <div class="row">
                                            <div class="col-xl-6">
                                                    <asp:Button ID="btnSendTestInvitation" OnClick="btnSendTestInvitation_Click" class="btn btn-secondary" runat="server" Text="Send Test Invitation"  />
                                                </div>
                                            </div>
                                            </div>
                                            </div>
