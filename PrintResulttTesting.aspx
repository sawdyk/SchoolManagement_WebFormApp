<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="PrintResulttTesting.aspx.cs" Inherits="PrintResulttTesting" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>DOWNLOAD/PRINT REPORT CARD</h4>
                                    </div>
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    <label class="form-control-label"> Report Type:<span class="text-danger ml-2">*</span></label>
                                <asp:DropDownList runat="server"  class="custom-select form-control" AutoPostBack="true" ID="ddlReportType">
...
<asp:DropDownList runat="server" AutoPostBack="true" class="custom-select form-control" ID="ddlAcademicSession">
                                    <asp:ListItem Enabled="true" Selected="True" Text="--  Select All --" Value="0"></asp:ListItem>
                                              ...
                                              <div class="form-group row mb-3">
                                                   ...
                                                   <asp:DropDownList runat="server" class="custom-select form-control" ID="ddlAcademicTerm" OnSelectedIndexChanged="ddlAcademicTerm_SelectedIndexChanged" AutoPostBack="true">
                                    <asp:ListItem Enabled="true" Selected="True" Text="--  Select All --" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                                                </div>
                                               <div class="col-xl-6">
                                 ...
                                 <div class="form-group row mb-3">
                                                   <div class="col-xl-6 mb-3">
                                                    ...
                                                    <asp:DropDownList runat="server" class="custom-select form-control"  ID="ddlGrade" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" DataTextField="GradeName" DataValueField="Id"
                                 AutoPostBack="true"  AppendDataBoundItems = "true">
                                </asp:DropDownList>
                                                </div>
                                               <div class="col-xl-6">
                                           <label class="form-control-label">Class Teachers Comment:<span class="text-danger ml-2">*</span></label>
                                               <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="Field is required" ControlToValidate="txtClassTeacherComment"></asp:RequiredFieldValidator>
                                <asp:TextBox runat="server" class="form-control" ID="txtClassTeacherComment" placeholder="Excellent"></asp:TextBox>
                                            </div>
                                            </div>
                                  <div class="form-group row mb-3">
                                 <div class="col-xl-6 mb-3">
                                                    <label class="form-control-label">Principal's Comment:<span class="text-danger ml-2">*</span></label>
                                               <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ErrorMessage="Field is required" ControlToValidate="txtProprietorComment"></asp:RequiredFieldValidator>
                                <asp:TextBox runat="server" class="form-control" ID="txtProprietorComment" placeholder="Good"></asp:TextBox>
                                                </div>
                                </div>

                
                    <asp:GridView ID="gdvList" runat="server" GridLines="None" ForeColor="Black" AutoGenerateColumns="false" class="table table-striped" EmptyDataText=" No result."
...
<%--                            <asp:TemplateField ShowHeader="false">
                   ...
                   <%-- <asp:GridView ID="gdvViewResult" GridLines="None" runat="server" AutoGenerateColumns="false" EmptyDataText=" No result."
                        AllowPaging="true" Width="100%" OnPageIndexChanging="gdvList_PageIndexChanging"
                        OnRowCommand="gdvList_RowCommand">
                        <AlternatingRowStyle BackColor="White" />
                        <EditRowStyle BackColor="#2461BF" />
...
<%--                            <asp:TemplateField HeaderText="Subject">
                                <ItemTemplate>
                                    <asp:Label ID="lblSubject" runat="server" Text='<%# Eval("Subject.Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Exam">
                                <ItemTemplate>
                                    <asp:Label ID="lblExam" runat="server" Text='<%# Eval("ExamScore") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblStudentAdmissionNumber" runat="server" Text='<%# Eval("AdmissionNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                     <%--   </Columns>
                        <PagerSettings FirstPageText="&lt;i class=&quot;fa  fa-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;fa fa-chevron-left&quot;&gt;&lt;/i&gt;" LastPageText="&lt;i class=&quot;fa fa-chevron-right&quot;&gt;&lt;/i&gt;&lt;i class=&quot;fa fa-chevron-right&quot;&gt;&lt;/i&gt;" Mode="NextPreviousFirstLast" NextPageText="&lt;i class=&quot;fa fa-arrow-right&quot;&gt;&lt;/i&gt;" PreviousPageText="&lt;i class=&quot;fa fa-arrow-left&quot;&gt;&lt;/i&gt;" />
