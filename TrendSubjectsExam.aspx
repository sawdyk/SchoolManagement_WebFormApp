<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="TrendSubjectsExam.aspx.cs" Inherits="TrendSubjectsExam" %>
                    ...
                    <div class="container-fluid">
                      ...
                      <%--  <div class="row">
                        ...
                        <div class="row flex-row">
                            ...
                            <asp:DropDownList runat="server" ID="ddlClass" DataTextField="Name" DataValueField="id" class="custom-select form-control" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" AutoPostBack="true"    >
                            </asp:DropDownList>
                                                </div>
                                                <div class="col-xl-6">
                                                    <label class="form-control-label">Grade:<span class="text-danger ml-2">*</span></label>
                            <asp:DropDownList ID="ddlGrade" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" class="custom-select form-control" DataTextField="GradeName" DataValueField="Id" AutoPostBack="true"    runat="server"></asp:DropDownList>                       
                            ...
                            <asp:DropDownList ID="ddlWard" DataTextField="GradeName" class="custom-select form-control" DataValueField="Id"  runat="server"></asp:DropDownList>                       
                                                       
                                                </div>
                                                  <div class="col-xl-6">
                                                 <label class="form-control-label">Subject:<span class="text-danger ml-2">*</span></label>
                            <asp:DropDownList ID="ddlSubject" class="custom-select form-control" runat="server"></asp:DropDownList>                       
                                        ...
                                        <br /><br />
                                                        <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="TREND SUBJECTS TEST"></asp:Label>
