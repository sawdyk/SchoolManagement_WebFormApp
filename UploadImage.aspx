<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="UploadImage.aspx.cs" Inherits="UploadImage" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>UPLOAD/UPDATE SCHOOL LOGO</h4>
                                    </div>
                                          ...
                                          <asp:Label ID="lblResult" runat="server" Visible="false" Text="" class="text-success ml-2"></asp:Label>
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    <label class="form-control-label">Upload Type:<span class="text-danger ml-2">*</span></label>
                                            <asp:DropDownList runat="server" class="custom-select form-control"  AutoPostBack ="true" ID="ddlUploadType">
                                            </asp:DropDownList>
                                                </div>
                                                <div class="col-xl-6">
