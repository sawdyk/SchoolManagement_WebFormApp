<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="DeleteScoresStudent.aspx.cs" Inherits="DeleteScoresStudent" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>DELETE UPLOADED SCORES(Single Student)</h4>
                                    </div>
                                     ...
                                     <asp:DropDownList runat="server" ID="ddlSubCategory" class="custom-select form-control" DataTextField="SubCategory" DataValueField="Id"></asp:DropDownList>
                                        ...
                                        <asp:DropDownList runat="server" class="custom-select form-control" DataValueField="Id" DataTextField="Code" ID="ddlCode2"></asp:DropDownList>
                                             ...
                                             <div class="form-group row mb-3">
                                              ...
                                              <asp:DropDownList runat = "server" class="custom-select form-control" ID = "ddlStudent" DataTextField="StudentFullName" DataValueField="Id"></asp:DropDownList>
                                           ...
                                           <div class="form-group row mb-3">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <asp:Button ID="btnDeleteScores" class="btn btn-secondary" OnClientClick="javascript:return confirm('Are you sure you want to this Record?');"   OnClick="btnDeleteScores_Click" runat="server" Text="Delete Uploaded Scores"  />
                                            </div>                           
