...
public partial class DeleteScoresBulk : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlSession.DataSource = new DeleteScoresBulk().schSession().Distinct();
    ...
    protected void ddlGrade_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //{
        //    ddlClassSubject.Items.Clear();
        //    IList<PASSIS.LIB.SubjectsInSchool> test = new SubjectTeachersLIB().getAllSubjectsForClassAndTeacher((long)logonUser.SchoolId, Convert.ToInt64(ddlYear.SelectedValue));
        //    foreach (PASSIS.LIB.SubjectsInSchool subjId in test)
        //    {
        //        PASSIS.LIB.Subject reqSubjects = context.Subjects.FirstOrDefault(c => c.Id == subjId.SubjectId);
        //        ddlClassSubject.Items.Add(new ListItem(reqSubjects.Name, reqSubjects.Id.ToString()));
