...
public partial class ParentViewReportCard_753 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new ParentViewReportCard_753().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new ParentViewReportCard_753().schTerm().Distinct();
