<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="SubjectScoreSheet.aspx.cs" Inherits="SubjectScoreSheet" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>GENERATE AND DOWNLOAD SUBJECT SCORESHEET</h4>
                                    </div>
                                    <div class="widget-body"> 
                                        <form class="form-horizontal">
                                            ...
                                            <asp:DropDownList runat="server" class="custom-select form-control" ID="ddlGrade" AutoPostBack="true" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" DataTextField="GradeName" DataValueField="Id"
                                    ...
                                    <asp:ListItem Enabled="true" Selected="True" Text="--  Select --" Value="0"></asp:ListItem>
                                               ...
                                               <asp:DropDownList runat="server" class="custom-select form-control" AutoPostBack="false" ID="ddlSubject" >
                                                    <asp:ListItem Enabled="true" Selected="True" Text="--  Select Subject--" Value="0"></asp:ListItem>
                                                </asp:DropDownList>                                             
                                                   </div>
                                               </div>  
                                                ...
                                                <div class="row">
                                            <div class="col-xl-6">
                                                    <asp:Button ID="btnPrintBroadsheet" class="btn btn-secondary"  OnClick="btnPrintBroadsheet_OnClick" runat="server" Text="Download ScoreSheet"  />
                                                </div>
                                            </div>
                                                </form>    
                                        <br /><br />
