<%@ Page Language="C#" AutoEventWireup="true"MasterPageFile="~/Site.master"  CodeFile="ViewScoreBulk.aspx.cs" Inherits="ViewScoreBulk" %>
                        ...
                        <div class="row flex-row" style="width:auto;">
                            <div class="col-12">
                             ...
                             <asp:DropDownList runat="server" AutoPostBack="true" class="custom-select form-control" DataTextField="Category" DataValueField="ID" ID="ddlCategory" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList>
                                     ...
                                     <asp:DropDownList runat="server" ID="ddlSubCategory" class="custom-select form-control" OnSelectedIndexChanged="ddlSubCategory_SelectedIndexChanged" AutoPostBack="true" DataTextField="SubCategory" DataValueField="Id"></asp:DropDownList>
                                                </div>
                                               <div class="col-xl-6">
                                                    <label class="form-control-label">Select Code:<span class="text-danger ml-2">*</span></label>
                             <asp:DropDownList runat="server" class="custom-select form-control" DataTextField="Code" DataValueField="Code" ID="ddlCode" OnSelectedIndexChanged="ddlCode_SelectedIndexChanged"></asp:DropDownList>
