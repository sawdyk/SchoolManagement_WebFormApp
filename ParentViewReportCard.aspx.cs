...
public partial class ParentViewReportCard : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //{
            ...
            Response.Redirect("ParentViewReportCard-" + logonUser.SchoolId + ".aspx");
        //}
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new ParentViewReportCard().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new ParentViewReportCard().schTerm().Distinct();
    ...
    protected void addResultSummaryPage(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        long gradeId = new ParentViewReportCard().theGradeId(student.Id).GradeId;
