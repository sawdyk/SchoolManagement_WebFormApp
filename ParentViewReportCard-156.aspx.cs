...
public partial class ParentViewReportCard_156 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new ParentViewReportCard_156().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new ParentViewReportCard_156().schTerm().Distinct();
        ...
        if (gs != null)
        {
            ...
            foreach (SubjectsInSchool subjects in sortedTScore)
            {
                ...
                if (subject != null)
                {
                    ...
                    //if (subjects.Exam == true && subjects.CA == false) // Only EXAM
                    //{
