                        ...
                        <div class="row flex-row">
                            <div class="col-12">
                              ...
                              <asp:Label ID="lblMsgDisplay" Font-Size="Large" runat="server" Visible="false" ForeColor="Black" ></asp:Label>
                                            <asp:GridView ID="gdvList" runat="server" Width="100%" ForeColor="Black" GridLines="None"  class="table table-striped" AutoGenerateColumns="false" EmptyDataText=" No Student(s) for this Session."
