<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ViewApplicantInterviewScores.aspx.cs" Inherits="ViewApplicantInterviewScores" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>ADMISSION APPLICANTS INTERVIEW SCORE LIST</h4>
                                    </div>
              ...
              <asp:GridView ID="gdvList" runat="server" ForeColor="Black" class="table table-striped"  AutoGenerateColumns="false" GridLines="None" EmptyDataText=" No record Currently exist "
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Interview Score">
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("InterviewScore")  %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText=" Gender ">
                                    <ItemTemplate>
                                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("AdmissionApp.Gender")  %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
