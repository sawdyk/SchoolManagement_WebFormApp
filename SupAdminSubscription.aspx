<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="SupAdminSubscription.aspx.cs" Inherits="SupAdminSubscription" %>
                        ...
                        <div class="row flex-row" style="width:auto;">
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPaymentDate" class="form-control"></asp:TextBox>
