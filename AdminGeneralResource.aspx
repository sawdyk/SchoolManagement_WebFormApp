<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="AdminGeneralResource.aspx.cs" Inherits="AdminGeneralResource" %>
    ...
    <div class="content-inner">
                    <div class="container-fluid">
                        ...
                        <div class="row flex-row">
                          ...
                          <asp:Label ID="lblAcademic" Font-Size="Large" runat="server" Visible="true" ForeColor="Black" Text="RESOURCES"></asp:Label>
                                        <asp:GridView ID="gdvList" runat="server" GridLines="None" class="table table-striped" ForeColor="Black" AutoGenerateColumns="false" OnRowCommand="gdvList_RowCommand" EmptyDataText=" No Document Type has been created"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="false">
                            <ItemTemplate>
                                    <asp:LinkButton ID="lnkDownload" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName='cmd' class="btn btn-success" SkinID="lnkGreen"> Download </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
