...
public partial class MaximumTestComparison : PASSIS.LIB.Utility.BasePage
{
    ...
    //protected void LoadCampus()
    //{
    //cmd = new SqlCommand("select Id, Name from SchoolCampus where SchoolId = " + SchoolID, con);
    //DataTable dt = new DataTable();
    //SqlDataAdapter dr = new SqlDataAdapter(cmd);
    //dr.Fill(dt);

    //    var campus = from c in db.SchoolCampus where c.SchoolId == logonUser.SchoolId select c;
    //    ddlCampusList.DataSource = campus;
    //    ddlCampusList.DataValueField = "Id";
    //    ddlCampusList.DataTextField = "Name";
    //    ddlCampusList.DataBind();
    // ddlCampusList.Items.Insert(0, new System.Web.UI.WebControls.ListItem("---Select---", "0", true));
