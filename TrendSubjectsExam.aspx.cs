...
public partial class TrendSubjectsExam : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void ddlGrade_SelectedIndexChanged(object sender, EventArgs e)
    {
       ...
       ddlSubject.Items.Clear();
        ...
        {
            PASSIS.LIB.Subject subjList = db.Subjects.FirstOrDefault(x => x.Id == classSubject.SubjectId);
