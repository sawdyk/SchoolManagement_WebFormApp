<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="DeleteScores.aspx.cs" Inherits="DeleteScores" %>
                      ...
                      <%--  <div class="row">
                        ...
                        <div class="row flex-row" style="width:auto;">
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>DELETE UPLOADED SCORES (single upload)</h4>
                                    </div>
                                 ...
                                 <asp:DropDownList runat="server" class="custom-select form-control" DataValueField="Id" DataTextField="Name"  ID="ddlClassSubject"></asp:DropDownList>
                              ...
                              <asp:DropDownList runat="server" class="custom-select form-control" DataTextField="Category" DataValueField="ID" AutoPostBack="true" ID="ddlCategory" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList>
                                     ...
                                     <asp:DropDownList runat="server" ID="ddlSubCategory" AutoPostBack="true" class="custom-select form-control" OnSelectedIndexChanged="ddlSubCategory_SelectedIndexChanged" DataTextField="SubCategory" DataValueField="Id"></asp:DropDownList>

                                                </div>
                                                <div class="col-xl-6">
                                                    <label class="form-control-label">Select Code:<span class="text-danger ml-2">*</span></label>
                                            <asp:DropDownList runat="server" ID="ddlCode2" class="custom-select form-control"  DataValueField="Id" DataTextField="Code"></asp:DropDownList>
                            ...
                            <PagerSettings FirstPageText="&lt;i class=&quot;fa  fa-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;fa fa-chevron-left&quot;&gt;&lt;/i&gt;"
                                ...
                                <asp:GridView ID="gdvExamScores" runat="server" class="table table-striped"  ForeColor="#333333" AutoGenerateColumns="false" EmptyDataText=" No scores available" 
                                    Width="100%"  GridLines="None">
                                    <AlternatingRowStyle BackColor="White" />
                                    <EditRowStyle BackColor="#2461BF" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText=" Admission No">
                                           ...
                                           <asp:TextBox ID="txtAdmissionNo" Text='<%# Eval("AdmissionNo")  %>' runat="server"></asp:TextBox>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblAdmNo" runat="server" Text='<%# new SchoolLIB().GetUserDetails(Eval("AdmissionNumber").ToString()).AdmissionNumber  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Code">
                                            <ItemTemplate>
