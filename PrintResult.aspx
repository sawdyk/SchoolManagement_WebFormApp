<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="PrintResult.aspx.cs" Inherits="PrintResult" %>
...
<asp:DropDownList runat="server" ID="ddlAcademicTerm" OnSelectedIndexChanged="ddlAcademicTerm_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Enabled="true" Selected="True" Text="--  Select All --" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                                </div>
                                            </div>
                                            ...
                                            <asp:ListItem Enabled="true" Selected="True" Text="--  Select All --" Value="0"></asp:ListItem>
                                               ...
                                               <div class="col-xl-6">
                                                 <label class="form-control-label">Grade:<span class="text-danger ml-2">*</span></label>
                                                     <asp:DropDownList runat="server" ID="ddlGrade" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" DataTextField="GradeName" DataValueField="Id"
 ...
 <PagerSettings FirstPageText="&lt;i class=&quot;la  la-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-left&quot;&gt;&lt;/i&gt;"
                                ...
                                NextPageText="&lt;i class=&quot;la la-arrow-right&quot;&gt;&lt;/i&gt;" PreviousPageText="&lt;i class=&quot;la la-arrow-left&quot;&gt;&lt;/i&gt;" />                            </asp:GridView>
