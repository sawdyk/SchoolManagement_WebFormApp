<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="TopNTestPerformance.aspx.cs" Inherits="TopNTestPerformance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">   
    ...
    <div class="content-inner">
                    <div class="container-fluid">
                            ...
                            <asp:DropDownList ID="ddlWard" DataTextField="GradeName" class="custom-select form-control" DataValueField="Id" AutoPostBack="true"    runat="server"></asp:DropDownList>                       
                                               ...
                                               <div class="col-xl-6">
                                                 <label class="form-control-label">Top(N):<span class="text-danger ml-2">*</span></label>
                                                   <asp:TextBox ID="txtTopNExam" placeholder="Enter Top(N)"  class="form-control" runat="server"></asp:TextBox>                        </td>
                                                ...
                                                <div class="row">
                                            <div class="col-xl-6">
                                             <asp:Button ID="btnViewTopN"  class="btn btn-secondary" OnClick="btnViewTopN_OnClick" runat="server" Text="View_Report" />
                                                </div>
                                            </div>
                                                </form>    
                                        <br /><br />
                                                        <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="TOP(N)TEST PERFORMANCE"></asp:Label>
                     ...
                     <rsweb:ReportViewer ID="ReportViewer1" BorderColor="Red" Width="1200px" Height="800px" runat="server"></rsweb:ReportViewer>
                                     </asp:Panel>
