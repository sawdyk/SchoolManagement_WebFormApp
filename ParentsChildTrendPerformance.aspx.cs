...
public partial class ParentsChildTrendPerformance : PASSIS.LIB.Utility.BasePage
{
    ...
    //    IList<PASSIS.LIB.SubjectsInSchool> classSubjects = new SubjectTeachersLIB().getAllSubjectsForClass((long)logonUser.SchoolId, Convert.ToInt64(ddlClass.SelectedValue));

    //    ddlSubject.Items.Add(new ListItem("--Select Subject--", "0"));
    //    foreach (PASSIS.LIB.SubjectsInSchool classSubject in classSubjects)
    //    {
    //        PASSIS.LIB.Subject subjList = context.Subjects.FirstOrDefault(x => x.Id == classSubject.SubjectId);
    //        ddlSubject.Items.Add(new ListItem(subjList.Name, subjList.Id.ToString()));
    //    }
    ...
    //    ddlGrade.DataBind();
    //    ddlGrade.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Class--", "0"));
    //}
    ...
    //        param[3] = new ReportParameter("SubjectID", ddlSubject.SelectedValue.ToString());
    ...
    //        RVReport.ServerReport.ReportPath = "/parentsreport/TRSP";
