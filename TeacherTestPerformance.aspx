<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="TeacherTestPerformance.aspx.cs" Inherits="TeacherTestPerformance" %>
                    ...
                    <div class="container-fluid">
                      ...
                      <%--  <div class="row">
                        ...
                        <div class="row flex-row">
                            ...
                            <asp:DropDownList ID="ddlClass" class="custom-select form-control" DataTextField="GradeName" DataValueField="Id" runat="server"></asp:DropDownList>                       
                            ...
                            <asp:DropDownList ID="ddlterm" class="custom-select form-control" runat="server"></asp:DropDownList>                       
                                            ...
                                            --%>
                                             <%--   <div class="widget-body">
                                                <div class="row">
                                            <div class="col-xl-6">
                                             <asp:Button ID="btnViewTopN"  class="btn btn-secondary" OnClick="ViewReports_Click" runat="server" Text="View_Report" />
                                                </div>
                                            </div>
                                                </form>    
                                        <br /><br />--%>
                                                        <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="TEST PERFORMANCE"></asp:Label>
