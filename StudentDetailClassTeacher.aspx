<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="StudentDetailClassTeacher.aspx.cs" Inherits="StudentDetailClassTeacher" %>
             ...
             <ItemTemplate>
                 <div class="content-inner">
                    <div class="container-fluid">
                      ...
                      <%--  <div class="row">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:HyperLink ID="hypLnkReturnToList" runat="server" NavigateUrl="~/TeacherViewStudents.aspx"><i class="la la-mail-reply"></i> Return to List </asp:HyperLink>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:HyperLink runat="server" ID="hypLnkEdit" NavigateUrl='<%# Eval("StudentId", "StudentDetailClassTeacher.aspx?mode=edit&id={0}") %>'><i class="la la-pencil"></i> Edit</asp:HyperLink>
                                                </div>
                                             </div>
                <asp:Image ID="Image1" Style="float: right" runat="server" ImageUrl='<%# String.Format("~/Passports/{0}", Eval("User.PassportFileName")) %>' />
                                          ...
                                          <div class="form-group row mb-3">
                                              ...
                                              <div class="col-xl-6 mb-3">
                                                   <label class="form-control-label">Bus Route:<span class="text-danger ml-2">*</span></label>
                                                       <asp:Label runat="server" ForeColor="Blue" Font-Bold="true" ID="Label1" Text='<%# Bind("User.BusRoute") %>' class="form-control-label"></asp:Label>
                                                </div>
                                              <div class="col-xl-6 mb-3">
                                                   <label class="form-control-label">Status:<span class="text-danger ml-2">*</span></label>
