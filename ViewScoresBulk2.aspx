<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ViewScoresBulk2.aspx.cs" Inherits="ViewScoresBulk2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">          
    <div class="content-inner">
                ...
                <asp:View ID="ViewTestAssignment" runat="server">
                    <asp:GridView ID="gvTestAssigment" AutoGenerateColumns="false" class="table table-striped"  ForeColor="#333333" GridLines="None" runat="server">
...
<%--                            <asp:TemplateField Visible="false">
                ...
                <asp:View ID="ViewExam" runat="server">
                    <asp:GridView ID="gvExam" AutoGenerateColumns="false" class="table table-striped"  ForeColor="#333333" GridLines="None" runat="server">
                        <AlternatingRowStyle BackColor="White" />
                                <EditRowStyle BackColor="#2461BF" />
                                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#3366ff" Font-Bold="True" ForeColor="White" />
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Fullname">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("StudentFullName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Admission No">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("AdmissionNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
<%--                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Score Obtainable">
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("ExamScoreObtainable") %>'>></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Score Obtained">
                                <ItemTemplate>
                    ...
                    <asp:GridView ID="gvBehavioural" AutoGenerateColumns="false" class="table table-striped"  ForeColor="#333333" GridLines="None" runat="server">
                        <Columns>
                            <asp:TemplateField HeaderText="S/N">
                                <ItemTemplate>
                                    <%# Container.DataItemIndex + 1 %>
...
<%--                            <asp:TemplateField Visible="false">
                ...
                <asp:View ID="ViewExtraCurricular" runat="server">
                    <asp:GridView ID="gvExtraCurricular" AutoGenerateColumns="false" class="table table-striped"  ForeColor="#333333" GridLines="None" runat="server">
                        <Columns>
                            <asp:TemplateField HeaderText="S/N">
                                <ItemTemplate>
                                    <%# Container.DataItemIndex + 1 %>
