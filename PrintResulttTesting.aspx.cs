...
public partial class PrintResulttTesting : PASSIS.LIB.Utility.BasePage
{
    #region viewstate
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new PrintResulttTesting().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new PrintResulttTesting().schTerm().Distinct();
    ...
    protected void addResultSummaryPageCrownMidTerm(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        long gradeId = new PrintResulttTesting().theGradeId(student.Id).GradeId;
