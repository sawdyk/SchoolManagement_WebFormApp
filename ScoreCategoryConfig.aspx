<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="ScoreCategoryConfig.aspx.cs" Inherits="ScoreCategoryConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">          
    <div class="content-inner">
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlYear" DataTextField="Name" DataValueField="Id" class="custom-select form-control" runat="server"></asp:DropDownList>
                                                </div>
                                                <div class="col-xl-6">
                                              ...
                                              <div class="form-group row mb-3">
                                                ...
                                                DataTextField="CategoryName" DataValueField="CategoryName" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged">  </asp:DropDownList>                                                   
                                            ...
                                            <div class="form-group row mb-3">
                                               ...
                                               <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="Field is required" ControlToValidate="txtPercentage"></asp:RequiredFieldValidator>
                ...
                <asp:Label ID="lblAcademic" Font-Size="Large" runat="server" Visible="true" ForeColor="Black" Text="LIST OF SCORE CATEGORY"></asp:Label>
                                        <asp:Panel ID="Panel2" Width="1000%" class="table table-striped" ScrollBars="Vertical" runat="server">
      <asp:GridView ID="gvCategory" EmptyDataText="No Category" Width="1000%" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" class="table table-striped"
                                                CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCancelingEdit="gvScoreGrades_RowCancelingEdit" PageSize="20" OnPageIndexChanging="gvScoreGrades_PageIndexChanging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Category">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtCategory" class="form-control" Text='<%# Eval("Category")  %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Class">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtClass" class="form-control" Text='<%# new ClassGradeLIB().RetrieveClassGrade((Int64)(Eval("ClassId"))).Name %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Session">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtSession" class="form-control" Text='<%# new AcademicSessionLIB().GetSessionById((Int64)(Eval("SessionId"))) %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Term">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtTerm" class="form-control" Text='<%# new AcademicTermLIB().GetTermById((Int64)(Eval("TermId"))) %>' runat="server" Enabled="false"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
