...
public partial class ParentViewReportCard_693 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new ParentViewReportCard_693().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new ParentViewReportCard_693().schTerm().Distinct();
    ...
    protected void addResultSummaryPageCrownEndTermNew(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        long gradeId = new ParentViewReportCard_693().theGradeId(student.Id, session).GradeId;
        ...
        if (gs != null)
        {
            ...
            foreach (SubjectDepartment dept in deptList)
            {
                ...
                foreach (SubjectsInSchool subjects in getSubjectInClass)
                {
                    ...
                    if (subject != null)
                    {
                        ...
                        ///------------------------------------ ----------------HW/PRO--------------------------------------------------//
                        ScoreSubCategoryConfiguration gtScoreHW1 = context.ScoreSubCategoryConfigurations.FirstOrDefault(s => s.ClassId == yearId && s.SessionId == session && s.TermId == 1 && s.SubCategory == "HW/PRO");
                        if (gtScoreHW1 != null)
                        {
                        ...
                        if (scoreRepoExamFirstTermm != null)
                        {
                        ...
                        ///------------------------------------ HW/PRO--------------------------//
                        ScoreSubCategoryConfiguration gtScoreHW2 = context.ScoreSubCategoryConfigurations.FirstOrDefault(s => s.ClassId == yearId && s.SessionId == session && s.TermId == 2 && s.SubCategory == "HW/PRO");
                        if (gtScoreHW2 != null)
                        {
                        ...
                        //countExam += scoreRepoExamFirstTerm.Count();
                        if (scoreRepoExamFirstTermm2 != null)
                        {
                        ...
                        if (totalOffered > 0)
                        {
                            PdfPCell noOfStudentsCell = new PdfPCell(new Phrase(totalOffered.ToString(), darkerGrnFnt6)); noOfStudentsCell.Colspan = 1;
            ...
            PdfPCell summaryRow2Cell1 = new PdfPCell(new Phrase("Class Teacher's Comment:", blackFnt)); summaryRow2Cell1.Colspan = 5; summaryRow2Cell1.HorizontalAlignment = Element.ALIGN_LEFT; summaryRow2Cell1.Border = 0;
            PdfPCell summaryRow2Cell2 = new PdfPCell(new Phrase(classTeacherComment, blackFnt)); summaryRow2Cell2.Colspan = 10; summaryRow2Cell2.Border = 0;

            PdfPCell summaryRow4Cell1 = new PdfPCell(new Phrase("Principal's Comment:", blackFnt)); summaryRow4Cell1.Colspan = 5; summaryRow4Cell1.HorizontalAlignment = Element.ALIGN_LEFT; summaryRow4Cell1.Border = 0;
            PdfPCell summaryRow4Cell2 = new PdfPCell(new Phrase(headTeacherComment, blackFnt)); summaryRow4Cell2.Colspan = 10; summaryRow4Cell2.Border = 0;
