...
public partial class ParentViewReportCard_754 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new ParentViewReportCard_754().schSession().Distinct();
            ...
            ddlAcademicTerm.DataSource = new ParentViewReportCard_754().schTerm().Distinct();
