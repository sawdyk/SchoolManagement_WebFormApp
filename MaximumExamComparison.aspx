<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="MaximumExamComparison.aspx.cs" Inherits="MaximumExamComparison" %>
                      ...
                      <%--  <div class="row">
                        ...
                        <div class="row flex-row">
                            ...
                            <asp:DropDownList ID="ddlWard" DataTextField="GradeName" class="custom-select form-control" DataValueField="Id" AutoPostBack="true"    runat="server"></asp:DropDownList>                       
                                        ...
                                        <br /><br />
                                                        <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="MAXIMUM EXAM COMPARISON"></asp:Label>
