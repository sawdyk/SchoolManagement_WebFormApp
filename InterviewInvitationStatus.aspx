<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="InterviewInvitationStatus.aspx.cs" Inherits="InterviewInvitationStatus" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>INTERVIEW INVITATION STATUS</h4>
                                    </div>
                 ...
                 <asp:GridView ID="gdvList" runat="server" ForeColor="Black" class="table table-striped" AutoGenerateColumns="false" GridLines="None" EmptyDataText=" No record Currently exist "
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText=" Status ">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblTestStatus" runat="server" Text='<%#  getLNStatus(Convert.ToInt64( Eval("InterviewInvitationStatus"))) %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                                                                     
