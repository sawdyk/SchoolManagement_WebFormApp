...
public partial class PrintResultt_754 : PASSIS.LIB.Utility.BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlAcademicSession.DataSource = new PrintResultt_754().schSession().Distinct();
    ...
    void Download(PASSIS.LIB.User student, Document document, UsersLIB usrDal)
    {
        ...
        {
            addResultSummaryPageTaiSolarinPrimaryFirst(document, student, usrDal);
        }
        else if (ddlAcademicTerm.SelectedValue == "3" )
        {
            addResultSummaryPageTaiSolarinPrimaryThird(document, student, usrDal);
        }
        //}
        //catch (Exception ex)
        //{
    ...
    protected void addResultSummaryPageTaiSolarinPrimaryFirst(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        PdfPCell innerCell1 = new PdfPCell(new Phrase("TAI SOLARIN MEMORIAL NURSERY AND PRIMARY SCHOOL", darkerRedFnt16)); innerCell1.Colspan = 9; innerCell1.Border = 0; innerCell1.HorizontalAlignment = Element.ALIGN_CENTER;
        ...
        PdfPCell cell16 = new PdfPCell(new Phrase(classPosition.ToString(), blackFnt8)); cell16.Colspan = 1; cell16.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        ...
        PdfPCell thirdRow2Cell1 = new PdfPCell(new Phrase("SUBJECT", whiteFnt7)); thirdRow2Cell1.Colspan = 3; thirdRow2Cell1.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell1.BackgroundColor = darkergrnFnt.Color;
         PdfPCell thirdRow2Cell2 = new PdfPCell(new Phrase("CA 40%", whiteFnt7)); thirdRow2Cell2.Colspan = 1; thirdRow2Cell2.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell2.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell3 = new PdfPCell(new Phrase("EXAM 60%", whiteFnt7)); thirdRow2Cell3.Colspan = 1; thirdRow2Cell3.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell3.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell4 = new PdfPCell(new Phrase("TOTAL 100%", whiteFnt7)); thirdRow2Cell4.Colspan = 1; thirdRow2Cell4.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell4.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell5 = new PdfPCell(new Phrase("GRADE", whiteFnt7)); thirdRow2Cell5.Colspan = 1; thirdRow2Cell5.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell5.BackgroundColor = darkergrnFnt.Color;
        ...
        PdfPCell thirdRow2Cell7 = new PdfPCell(new Phrase("REMARK", whiteFnt7)); thirdRow2Cell7.Colspan = 2; thirdRow2Cell7.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell7.BackgroundColor = darkergrnFnt.Color;
                ...
                if (subject != null)
                {
                    ...
                    if (checkExist != null && checkExist.Exam == true && checkExist.CA == false) //Only Exam
                    {
                        ...
                        if (stdScore.Count > 0)
                        {
                            ...
                            {
                                examPercentageScore = Math.Round((decimal)s.ExamScore, 0);
                            }
        ...
        PdfPCell row1col2 = new PdfPCell(new Phrase("", blackFnt6)); row1col2.Colspan = 1; /*row1col2.BackgroundColor = darkergrnFnt.Color;*/
        ...
        PdfPTable scaleTable = new PdfPTable(1);
        PdfPCell scalerow0col1 = new PdfPCell(new Phrase("SCALE", blackFnt6)); scalerow0col1.Colspan = 1; scalerow0col1.HorizontalAlignment = Element.ALIGN_CENTER; /*scalerow0col1.BackgroundColor = darkergrnFnt.Color;*/
        PdfPCell scalerow1col1 = new PdfPCell(new Phrase("5 EXCELLENT", blackFnt6)); scalerow1col1.Colspan = 1; scalerow1col1.Border = 0;
        PdfPCell scalerow2col1 = new PdfPCell(new Phrase("4 GOOD", blackFnt6)); scalerow2col1.Colspan = 1; scalerow2col1.Border = 0;
        PdfPCell scalerow3col1 = new PdfPCell(new Phrase("3 FAIR", blackFnt6)); scalerow3col1.Colspan = 1; scalerow3col1.Border = 0;
        PdfPCell scalerow4col1 = new PdfPCell(new Phrase("2 POOR", blackFnt6)); scalerow4col1.Colspan = 1; scalerow4col1.Border = 0;
        PdfPCell scalerow5col1 = new PdfPCell(new Phrase("1 VERY POOR", blackFnt6)); scalerow5col1.Colspan = 1; scalerow5col1.Border = 0;
        ...
        PdfPCell affectiverow2col1 = new PdfPCell(new Phrase("", blackFnt6)); affectiverow2col1.Colspan = 1; /*affectiverow2col1.BackgroundColor = darkergrnFnt.Color;*/
        ...
        foreach (ScoreSubCategoryConfiguration s in extra)
        {
            ...
            PdfPCell psychoCells1 = new PdfPCell(new Phrase(s.SubCategory, blackFnt6)); psychoCells1.Colspan = 3;
            psychomotorTable.AddCell(psychoCells1);
            if (ssb != null)
            {
                PdfPCell psychoCells2 = new PdfPCell(new Phrase(Convert.ToInt16(ssb.MarkObtained).ToString(), blackFnt6)); psychoCells2.Colspan = 1;
                psychomotorTable.AddCell(psychoCells2);
            }
            else if (ssb == null)
            {
                PdfPCell psychoCells2 = new PdfPCell(new Phrase("", blackFnt6)); psychoCells2.Colspan = 1;
                psychomotorTable.AddCell(psychoCells2);
            }
        }
        ...
        foreach (ScoreSubCategoryConfiguration s in behavioral)
        {
            ...
            PdfPCell affectiveCells1 = new PdfPCell(new Phrase(s.SubCategory, blackFnt6)); affectiveCells1.Colspan = 3;
            affectiveTable.AddCell(affectiveCells1);
            if (ssb != null)
            {
                PdfPCell affectiveCells2 = new PdfPCell(new Phrase(Convert.ToInt16(ssb.MarkObtained).ToString(), blackFnt6)); affectiveCells2.Colspan = 1;
                affectiveTable.AddCell(affectiveCells2);
            }
            else if (ssb == null)
            {
                PdfPCell affectiveCells2 = new PdfPCell(new Phrase("", blackFnt6)); affectiveCells2.Colspan = 1;
                affectiveTable.AddCell(affectiveCells2);
            }
        }


        PdfPTable baseTbl = new PdfPTable(9);
        PdfPCell psych = new PdfPCell(psychomotorTable); psych.Colspan = 4;
        PdfPCell scale = new PdfPCell(scaleTable); scale.Colspan = 1;
        ...
        PdfPCell commentsRow00Cell1 = new PdfPCell(new Phrase("TOTAL SCORES", blackFnt6)); commentsRow00Cell1.Colspan = 2; commentsRow00Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell1.Border = 0;*/
        PdfPCell commentsRow00Cell2 = new PdfPCell(new Phrase(aggregateTotalScore.ToString(), blackFnt6)); commentsRow00Cell2.Colspan = 5; commentsRow00Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell2.Border = 0;*/

        PdfPCell commentsRow01Cell1 = new PdfPCell(new Phrase("PERCENTAGE", blackFnt6)); commentsRow01Cell1.Colspan = 2; commentsRow01Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell1.Border = 0;*/
        PdfPCell commentsRow01Cell2 = new PdfPCell(new Phrase(percentage.ToString()+"%", blackFnt6)); commentsRow01Cell2.Colspan = 5; commentsRow01Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell2.Border = 0;*/

        PdfPCell commentsRow1Cell1 = new PdfPCell(new Phrase("NO OF TIMES SCHOOL OPENED", blackFnt6)); commentsRow1Cell1.Colspan = 2; commentsRow1Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell1.Border = 0;*/
        PdfPCell commentsRow1Cell2 = new PdfPCell(new Phrase("", blackFnt6)); commentsRow1Cell2.Colspan = 5; commentsRow1Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow1Cell2.Border = 0;*/

        PdfPCell commentsRow2Cell1 = new PdfPCell(new Phrase("NO OF TIMES PRESENT", blackFnt6)); commentsRow2Cell1.Colspan = 2; commentsRow2Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow2Cell1.Border = 0;*/
        PdfPCell commentsRow2Cell2 = new PdfPCell(new Phrase("", blackFnt6)); commentsRow2Cell2.Colspan = 5; commentsRow2Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow2Cell2.Border = 0;*/

        PdfPCell commentsRow3Cell1 = new PdfPCell(new Phrase("CLASS TEACHERS COMMENT", blackFnt6)); commentsRow3Cell1.Colspan = 2; commentsRow3Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow3Cell1.Border = 0;*/
        ...
        PdfPCell commentsRow4Cell1 = new PdfPCell(new Phrase("CLASS TEACHERS SIGNATURE", blackFnt6)); commentsRow4Cell1.Colspan = 2; commentsRow4Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow4Cell1.Border = 0;*/
        PdfPCell commentsRow4Cell2 = new PdfPCell(sign); commentsRow4Cell2.Colspan = 5; commentsRow4Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow4Cell2.Border = 0;*/

        PdfPCell commentsRow5Cell1 = new PdfPCell(new Phrase("HEAD TEACHERS COMMENT", blackFnt6)); commentsRow5Cell1.Colspan = 2; commentsRow5Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow5Cell1.Border = 0;*/
        ...
        PdfPCell commentsRow6Cell1 = new PdfPCell(new Phrase("HEAD TEACHERS SIGNATURE", blackFnt6)); commentsRow6Cell1.Colspan = 2; commentsRow6Cell1.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow6Cell1.Border = 0;*/
        PdfPCell commentsRow6Cell2 = new PdfPCell(new Phrase("", blackFnt6)); commentsRow6Cell2.Colspan = 5; commentsRow6Cell2.HorizontalAlignment = Element.ALIGN_LEFT; /*commentsRow6Cell2.Border = 0;*/

        commentsTable.AddCell(commentsRow00Cell1);
        commentsTable.AddCell(commentsRow00Cell2);

        commentsTable.AddCell(commentsRow01Cell1);
        commentsTable.AddCell(commentsRow01Cell2);
        ...
        PdfPCell commentsTbl = new PdfPCell(commentsTable); commentsTbl.Colspan = 8;
        PdfPCell gradeTbl = new PdfPCell(gradeTable); gradeTbl.Colspan = 3;
    ...
    protected void addResultSummaryPageTaiSolarinPrimaryThird(Document document, PASSIS.LIB.User student, UsersLIB usrDal)
    {
        ...
        PdfPCell cell14 = new PdfPCell(new Phrase(ddlYear.SelectedItem.ToString(), blackFnt8)); cell14.Colspan = 3; cell14.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        PdfPCell cell15 = new PdfPCell(new Phrase("POSITION IN CLASS", blackFnt8)); cell15.Colspan = 2; cell15.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        PdfPCell cell16 = new PdfPCell(new Phrase(classPosition, blackFnt8)); cell16.Colspan = 1; cell16.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;

        PdfPCell cell17 = new PdfPCell(new Phrase("PROMOTED", blackFnt8)); cell17.Colspan = 2; cell17.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        PdfPCell cell18 = new PdfPCell(new Phrase("YES", blackFnt8)); cell18.Colspan = 3; cell18.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        PdfPCell cell19 = new PdfPCell(new Phrase("NEXT TERM BEGINS", blackFnt8)); cell19.Colspan = 2; cell19.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        PdfPCell spaceCol1 = new PdfPCell(new Phrase("", blackFnt8)); spaceCol1.Colspan = 1; spaceCol1.HorizontalAlignment = Element.ALIGN_LEFT; //cell4.Border = 0;
        ...
        PdfPCell thirdRow2Cell3 = new PdfPCell(new Phrase("EXAM 60%", whiteFnt7)); thirdRow2Cell3.Colspan = 1; thirdRow2Cell3.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell3.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell4 = new PdfPCell(new Phrase("TOTAL 100%", whiteFnt7)); thirdRow2Cell4.Colspan = 1; thirdRow2Cell4.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell4.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell5 = new PdfPCell(new Phrase("1ST TERM", whiteFnt7)); thirdRow2Cell5.Colspan = 1; thirdRow2Cell5.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell5.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell6 = new PdfPCell(new Phrase("2ND TERM", whiteFnt7)); thirdRow2Cell6.Colspan = 1; thirdRow2Cell6.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell6.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell7 = new PdfPCell(new Phrase("AVERAGE SCORE", whiteFnt7)); thirdRow2Cell7.Colspan = 1; thirdRow2Cell7.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell7.BackgroundColor = darkergrnFnt.Color;
        PdfPCell thirdRow2Cell8 = new PdfPCell(new Phrase("GRADE", whiteFnt7)); thirdRow2Cell8.Colspan = 1; thirdRow2Cell8.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell8.BackgroundColor = darkergrnFnt.Color;
        ...
        PdfPCell thirdRow2Cell10 = new PdfPCell(new Phrase("REMARK", whiteFnt7)); thirdRow2Cell10.Colspan = 2; thirdRow2Cell10.HorizontalAlignment = Element.ALIGN_CENTER; thirdRow2Cell10.BackgroundColor = darkergrnFnt.Color;
            ...
            foreach (SubjectsInSchool subjects in getSubjectInClass)
            {
                ...
                if (subject != null)
                {
                    ...
                    else if (checkExist != null && checkExist.CA == true && checkExist.Exam == false)
                    {
                        ...
                        PdfPCell CACell = new PdfPCell(new Phrase("", darkerGrnFnt8)); CACell.Colspan = 1;
                        resTable.AddCell(CACell);
                        PdfPCell ExamCell = new PdfPCell(new Phrase(Math.Round(totalScore, 0).ToString(), darkerGrnFnt8)); ExamCell.Colspan = 1;
                        resTable.AddCell(ExamCell);
                    ...
                    if (checkExistt != null && checkExistt.Exam == true && checkExistt.CA == false) //Only Exam
                    {
                        ...
                        IList<PASSIS.LIB.StudentScore> stdScoree = getSubjectScoreCategoryExam(student.AdmissionNumber, student.Id, session, 1, schoolId, yearId, gradeId, subject.Id);

                        if (stdScoree.Count > 0)
                        {
                            foreach (PASSIS.LIB.StudentScore s in stdScoree)
                            {
                                examPercentageScore = Math.Round((decimal)s.ExamScore, 0);
                                break;
                            }
                    ...
                    else //EXAM AND CA
                    {
                        ...
                        IList<PASSIS.LIB.StudentScore> scoreRepoExamFirstTerm1 = getSubjectScoreCategoryExam(student.AdmissionNumber, student.Id, session, 1, schoolId, yearId, gradeId, subject.Id);
                        if (scoreRepoExamFirstTerm1.Count > 0)
                        {
                            foreach (PASSIS.LIB.StudentScore fs in scoreRepoExamFirstTerm1)
                            {
                                firstTermExam = Convert.ToDecimal(fs.ExamScore);
                                break;
                            }
                        }
                        else
                    ...
                    if (checkExisttt != null && checkExisttt.Exam == true && checkExisttt.CA == false) //Only Exam
                    {
                        ...
                        IList<PASSIS.LIB.StudentScore> stdScoree = getSubjectScoreCategoryExam(student.AdmissionNumber, student.Id, session, 2, schoolId, yearId, gradeId, subject.Id);
                    ...
                    else //EXAM AND CA
                    {
                        ...
                        IList<PASSIS.LIB.StudentScore> scoreRepoExamSecondTerm1 = getSubjectScoreCategoryExam(student.AdmissionNumber, student.Id, session, 2, schoolId, yearId, gradeId, subject.Id);
                        if (scoreRepoExamSecondTerm1.Count > 0)
                        {
                            foreach (PASSIS.LIB.StudentScore fs in scoreRepoExamSecondTerm1)
                            {
                                secondTermExam = Convert.ToDecimal(fs.ExamScore);
                                break;
                            }
                        }
                        else
        ...
        PdfPCell row1col1 = new PdfPCell(new Phrase("PSYCHOMOTOR SKILLS", blackFnt6)); row1col1.Colspan = 4; row1col1.HorizontalAlignment = Element.ALIGN_LEFT;/* row1col1.BackgroundColor = darkergrnFnt.Color;*/
        PdfPCell row1col2 = new PdfPCell(new Phrase("", whiteFnt6)); row1col2.Colspan = 1; /*row1col2.BackgroundColor = darkergrnFnt.Color;*/
        ...
        PdfPTable scaleTable = new PdfPTable(2);
        PdfPCell scalerow0col1 = new PdfPCell(new Phrase("SCALE", blackFnt6)); scalerow0col1.Colspan = 2; scalerow0col1.HorizontalAlignment = Element.ALIGN_CENTER; /*scalerow0col1.BackgroundColor = darkergrnFnt.Color;*/
        PdfPCell scalerow1col1 = new PdfPCell(new Phrase("5 EXCELLENT", blackFnt6)); scalerow1col1.Colspan = 2; scalerow1col1.Border = 0;
        PdfPCell scalerow2col1 = new PdfPCell(new Phrase("4 GOOD", blackFnt6)); scalerow2col1.Colspan = 2; scalerow2col1.Border = 0;
        PdfPCell scalerow3col1 = new PdfPCell(new Phrase("3 FAIR", blackFnt6)); scalerow3col1.Colspan = 2; scalerow3col1.Border = 0;
        PdfPCell scalerow4col1 = new PdfPCell(new Phrase("2 POOR", blackFnt6)); scalerow4col1.Colspan = 2; scalerow4col1.Border = 0;
        PdfPCell scalerow5col1 = new PdfPCell(new Phrase("1 VERY POOR", blackFnt6)); scalerow5col1.Colspan = 2; scalerow5col1.Border = 0;
        ...
        PdfPCell affectiverow1col1 = new PdfPCell(new Phrase("AFFECTIVE AREAS", blackFnt6)); affectiverow1col1.Colspan = 4; affectiverow1col1.HorizontalAlignment = Element.ALIGN_LEFT; /*affectiverow1col1.BackgroundColor = darkergrnFnt.Color;*/
        PdfPCell affectiverow2col1 = new PdfPCell(new Phrase("", blackFnt6)); affectiverow2col1.Colspan = 1; /*affectiverow2col1.BackgroundColor = darkergrnFnt.Color;*/
        ...
        PdfPTable finalTable = new PdfPTable(11);
        PdfPCell commentsTbl = new PdfPCell(commentsTable); commentsTbl.Colspan = 9;
