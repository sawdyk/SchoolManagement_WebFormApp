<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ViewAdmissionApplication.aspx.cs" Inherits="ViewAdmissionApplication" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>ADMISSION APPLICANTS LISTS</h4>
                                    </div>
                                    <div class="widget-body"> 
                                   
                                                    <asp:label runat="server" Text="Applicants List" ForeColor="Black" Font-Size="Large" Visible="true"></asp:label>
...
<%--                                <asp:TemplateField HeaderText="Admission Year">
                                ...
                                <asp:TemplateField HeaderText=" Gender ">
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("AdmissionApp.Gender")  %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
