...
public partial class ComputeResult2 : PASSIS.LIB.Utility.BasePage
{
                    ...
                    foreach (PASSIS.LIB.GradeStudent std in gradeStudent)
                    {
                        try
                        {
                            ...
                            if (scor != null)
                            {
                                try
                                {
                                    //IList<StudentScoreRepository> scoreRepository = new ScoresheetLIB().getScorelist(sessionId, TermId, Convert.ToInt64(subjectId), std.User.AdmissionNumber, logonUser.SchoolCampusId);
