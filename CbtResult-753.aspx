<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="CbtResult-753.aspx.cs" Inherits="CbtResult_753" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>DOWNLOAD/PRINT CBT RESULT</h4>
                                    </div>
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlAcademicTerm" class="custom-select form-control" OnSelectedIndexChanged="ddlAcademicTerm_SelectedIndexChanged" AutoPostBack="true">
                                            ...
                                            AutoPostBack="true" AppendDataBoundItems="true">
                                             ...
                                             <div class="form-group row mb-3">
                                                   ...
                                                   <asp:DropDownList runat="server" AutoPostBack="true" ID="ddlType" AppendDataBoundItems="true"
                                            DataTextField="Type" DataValueField="Id" class="custom-select form-control">
                                        </asp:DropDownList>
                                                </div>
                                                  <div class="col-xl-6">
                                                 <label class="form-control-label">Category:<span class="text-danger ml-2">*</span></label>
                                                     <asp:DropDownList runat="server" ID="ddlCategory" class="custom-select form-control" DataTextField="Category" DataValueField="Id"
                                            AutoPostBack="true" AppendDataBoundItems="true">
                                           <asp:ListItem Enabled="true" Selected="false" Text="Both" Value="3"></asp:ListItem>
                                        </asp:DropDownList>         
                             ...
                             <asp:Label ID="lblMsgDisplay" Font-Size="Large" runat="server" Visible="false" ForeColor="Black" ></asp:Label>
                                            <asp:GridView ID="gdvList" runat="server" Width="100%" GridLines="None" ForeColor="Black" class="table table-striped" AutoGenerateColumns="false" EmptyDataText=" No result."
