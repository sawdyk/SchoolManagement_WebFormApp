<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="AdmissionStatus.aspx.cs" Inherits="AdmissionStatus" %>
                      ...
                      <PagerSettings FirstPageText="&lt;i class=&quot;la  la-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-left&quot;&gt;&lt;/i&gt;" LastPageText="&lt;i class=&quot;la la-chevron-right&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-right&quot;&gt;&lt;/i&gt;" Mode="NextPreviousFirstLast" NextPageText="&lt;i class=&quot;la la-arrow-right&quot;&gt;&lt;/i&gt;" PreviousPageText="&lt;i class=&quot;la la-arrow-left&quot;&gt;&lt;/i&gt;" />
                                     ...
                                     <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    <asp:label  runat="server" Visible="false" class="form-control-label">Upload File:<span class="text-danger ml-2">*</span></asp:label>
                                                   <asp:FileUpload ID="bulkUploadFile" class="form-control" runat="server"  Visible="false"/>
                                                </div>
                                                 <div class="col-xl-6">
                                                     <br />
                        <asp:Button ID="btnSendAdmissionNotification" OnClick="btnSendAdmissionNotification_Click" class="btn btn-secondary" runat="server" Visible ="false" Text="Admission Notification" Font-Size="Smaller" />
                                                </div>
                                            </div>
                                            </div>
                                            </div>
