<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="DeleteScoresSingle.aspx.cs" Inherits="DeleteScoresSingle" %>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>DELETE SINGLE SUBJECT SCORES(Bulk upload)</h4>
                                    </div>
                                    ...
                                    <asp:DropDownList runat="server" class="custom-select form-control"  AutoPostBack="true" ID="ddlYear" AppendDataBoundItems="true"
                                     ...
                                     <asp:DropDownList runat="server" ID="ddlClassSubject" class="custom-select form-control" DataTextField="Name" DataValueField="Id"></asp:DropDownList>
                                                </div>
                                                <div class="col-xl-6">
