<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="PrintReportCardConfig.aspx.cs" Inherits="PrintReportCardConfig" %>
          ...
          <div class="content-inner">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlGrade" AutoPostBack="true" class="custom-select form-control" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged" DataTextField="GradeName" DataValueField="Id"
                                             ...
                                             <div class="form-group row mb-3">
                                                   <div class="col-xl-6 mb-3">
                                                    ...
                                                    <asp:DropDownList runat="server" AutoPostBack="false" class="custom-select form-control" ID="ddlCategory" AppendDataBoundItems="true" >
                                            </asp:DropDownList>
                                                </div>
                                            </div>
                                            </form>
                    ...
                    <asp:Label ID="lblMsgDisplay" Font-Size="Large" runat="server" Text="LIST OF SUBJECTS" Visible="false" ForeColor="Black" ></asp:Label>
                                ...
                                <br />
                                   <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                  <asp:Button ID="btnSaveConfig" class="btn btn-secondary" runat="server" Text="Save"  OnClick="btnSaveConfig_OnClick" />
