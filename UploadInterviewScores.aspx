<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="UploadInterviewScores.aspx.cs" Inherits="UploadInterviewScores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">   
    ...
    <div class="content-inner">
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>UPLOAD ADMISSION INTERVIEW SCORES</h4>
                                    </div>
                ...
                <asp:GridView ID="gdvList" runat="server" AutoGenerateColumns="false" GridLines="None" EmptyDataText=" No record Currently exist "
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Interview Score">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtInterviewScore" Text='<%# Eval("InterviewScore")  %>' Visible="false" runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<PagerSettings FirstPageText="&lt;i class=&quot;la  la-chevron-left&quot;&gt;&lt;/i&gt;&lt;i class=&quot;la la-chevron-left&quot;&gt;&lt;/i&gt;"
                     ...
                     <div class="row">
                        <div class="col-xl-6">
                              <asp:Button ID="btnSaveInterviewScore" class="btn btn-secondary" OnClick="btnSaveInterviewScore_Click"  runat="server" Text="Save" />
                            </div>
                         </div>
                                            </div>
                                            </div>
